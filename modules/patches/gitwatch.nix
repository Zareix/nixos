# Based on https://github.com/gitwatch/gitwatch/blob/master/module.nix
# Fixes the message parameters
{
  lib,
  pkgs,
  pkgs-unstable,
    ...
    type = with types;
      attrsOf (submodule {
        options = {
          ...
          message = mkOption {
            description = "Optional text to use as commit message; all occurrences of `%d` will be replaced by formatted date/time";
            type = nullOr str;
            default = null;
          };
          branch = mkOption {
